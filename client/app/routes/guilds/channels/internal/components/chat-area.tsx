...
const mockMessages: MessageData[] = [
	...
	},
	{
		id: "2",
		content:
			"This is a sample message to show how the chat area looks with multiple messages.",
		author: {
			id: "user2",
			name: "TestUser",
		},
	...
	},
	{
		id: "3",
		content:
			"You can reply to messages and use reactions! The interface is designed to be similar to Discord.",
		author: {
			id: "user3",
			name: "Developer",
		},
