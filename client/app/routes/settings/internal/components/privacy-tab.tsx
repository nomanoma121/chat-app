import { AlertTriangle, Check, Eye, Lock, Shield } from "lucide-react";
					...
					>
						...
						<button
							...
							className={css({
								...
								height: "20px",
								border: "2px solid",
								borderColor: settings.onlineStatus
									? "accent.default"
									: "border.default",
								borderRadius: "sm",
								background: settings.onlineStatus
									? "accent.default"
									: "transparent",
								display: "flex",
								alignItems: "center",
					...
					>
						...
						<button
							...
							className={css({
								...
								height: "20px",
								border: "2px solid",
								borderColor: settings.allowDMs
									? "accent.default"
									: "border.default",
								borderRadius: "sm",
								background: settings.allowDMs
									? "accent.default"
									: "transparent",
								display: "flex",
								alignItems: "center",
